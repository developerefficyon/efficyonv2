...
export default function QuickBooksIntegrationPage() {
  ...
  return (
    <>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: jsonLdScript([breadcrumbListLd([{ name: "Home", path: "/" }, { name: "Integrations", path: "/integrations" }, { name: "QuickBooks", path: "/integrations/quickbooks" }])]) }}
      />
