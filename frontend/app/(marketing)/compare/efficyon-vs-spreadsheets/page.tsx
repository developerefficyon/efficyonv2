...
export default function EfficyonVsSpreadsheetsPage() {
  ...
  return (
    <>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: jsonLdScript([breadcrumbListLd([{ name: "Home", path: "/" }, { name: "Compare", path: "/compare" }, { name: "Efficyon vs Spreadsheets", path: "/compare/efficyon-vs-spreadsheets" }])]) }}
      />
