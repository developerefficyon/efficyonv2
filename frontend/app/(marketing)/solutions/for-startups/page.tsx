...
export default function ForStartupsPage() {
  ...
  return (
    <>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: jsonLdScript([breadcrumbListLd([{ name: "Home", path: "/" }, { name: "Solutions", path: "/solutions" }, { name: "For Startups", path: "/solutions/for-startups" }])]) }}
      />
