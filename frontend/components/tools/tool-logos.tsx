...
export const TOOL_BRANDS: Record<string, ToolBrand> = {
  ...
  notion: {
    color: "#000000",
    // Official Notion mark from simple-icons (full path including outer
    // book-binding subpath — earlier version was missing the final M segment).
    path: (
      <path
        fill="#000000"
  ...
  asana: {
    color: "#F06A6A",
    // Asana three-dots-in-a-triangle mark (simple-icons).
    path: (
      <path
        fill="currentColor"
        d="M18.78 12.653c-2.882 0-5.22 2.336-5.22 5.22 0 2.88 2.338 5.22 5.22 5.22 2.882 0 5.22-2.34 5.22-5.22 0-2.884-2.338-5.22-5.22-5.22zm-13.56 0C2.337 12.653 0 14.99 0 17.873c0 2.881 2.337 5.22 5.22 5.22 2.882 0 5.22-2.339 5.22-5.22 0-2.883-2.338-5.22-5.22-5.22zM17.22 5.22c0 2.882-2.337 5.22-5.22 5.22-2.882 0-5.22-2.338-5.22-5.22 0-2.881 2.338-5.22 5.22-5.22 2.883 0 5.22 2.339 5.22 5.22z"
      />
    ),
  },
  airtable: {
    ...
    // sourced from simple-icons.
    path: (
      <>
        <path
          fill="#FCB400"
          d="M11.992 1.966c-.633 0-1.214.044-1.585.176L1.39 5.736c-.486.194-.482.863.006 1.05L10.27 10.2a4.4 4.4 0 003.213 0l8.875-3.414c.488-.187.492-.856.006-1.05l-9.017-3.594c-.371-.132-.952-.176-1.355-.176z"
        />
        <path
          fill="#18BFFF"
          d="M13.181 11.198v9.872a.51.51 0 00.696.473l9.89-3.832a.508.508 0 00.317-.474V7.367a.51.51 0 00-.696-.474l-9.89 3.831a.508.508 0 00-.317.474z"
        />
        <path
          fill="#F82B60"
          d="M10.439 11.733l-2.937 1.418-.298.144-6.215 2.978c-.336.16-.769-.084-.769-.456V7.408c0-.134.069-.25.161-.337a.605.605 0 01.21-.117c.205-.082.474-.06.69.045l9.114 3.61c.464.183.467.84.044 1.124z"
        />
        <path
          fill="#000"
          opacity="0.25"
          d="M10.439 11.733l-2.937 1.418L.221 7.071a.605.605 0 01.21-.117c.205-.082.474-.06.69.045l9.114 3.61c.464.183.467.84.044 1.124z"
        />
      </>
    ),
  },
