...
if (!supabaseUrl || !supabaseServiceKey) {
  console.error("❌ Error: SUPABASE_URL and SUPABASE_SERVICE_ROLE_KEY must be set in .env.staging file")
  process.exit(1)
}
...
const ADMIN_EMAIL = process.env.ADMIN_EMAIL || "admin@efficyon.com"
const ADMIN_PASSWORD = process.env.ADMIN_PASSWORD || "Admin@123456"
const ADMIN_NAME = "Admin User"

async function seedAdmin() {
  console.log("🌱 Starting admin seed for STAGING...")
  ...
  try {
    ...
    if (existingAdmin) {
      ...
      if (existingProfile) {
        ...
        console.log("\n✨ Seed completed! Admin user is ready for STAGING.")
        console.log(`\n📝 Login credentials:`)
    ...
    console.log("\n✨ Seed completed successfully for STAGING!")
