...
async function uploadFile(req, res) {
  try {
    ...
    // Only use hint when auto-detection has low confidence; otherwise trust the detected schema
    ...
    const schemaToIntegration = {
      ...
      m365: "Microsoft365",
      m365_licenses: "Microsoft365",
      m365_users: "Microsoft365",
      m365_usage: "Microsoft365",
      hubspot: "HubSpot",
      profit_loss: "Fortnox",
    ...
    const schemaToDataType = {
      ...
      m365_licenses: "licenses",
      m365_users: "users",
      m365_usage: "usage_reports",
