...
// Get all recommendations for the user's company (optionally filtered by provider)
async function getRecommendations(req, res) {
  const endpoint = "GET /api/integrations/quickbooks/recommendations"
  log("log", endpoint, "Request received")
...
async function applyRecommendation(req, res) {
  const endpoint = "POST /api/integrations/quickbooks/recommendations/apply"
  log("log", endpoint, "Request received")
...
async function updateRecommendationSteps(req, res) {
  const endpoint = "PATCH /api/integrations/quickbooks/recommendations/steps"
  log("log", endpoint, "Request received")
...
async function deleteRecommendation(req, res) {
  const endpoint = "DELETE /api/integrations/quickbooks/recommendations"
  log("log", endpoint, "Request received")
